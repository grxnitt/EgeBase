      ...
      <div className="rounded-[18px] border border-border bg-surface p-5 sm:p-7">
        ...
        <div className="mt-7">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              className={`inline-flex items-center rounded-smds border px-4 py-2 text-sm font-semibold transition-[border-color,background-color,box-shadow,color] ${
        ...
        <div className="mt-7">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {countOptions.map((count) => (
              <button
                className={`inline-flex h-10 min-w-12 items-center justify-center rounded-smds border px-3 text-sm font-bold transition-[border-color,background-color,box-shadow,color] ${
